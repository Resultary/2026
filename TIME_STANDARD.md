...
Resultary uses Coordinated Universal Time (UTC) for every date and timestamp
visible in the public record.
...
- Submission, version, review, correction, and publication times preserve the
  same UTC standard.
